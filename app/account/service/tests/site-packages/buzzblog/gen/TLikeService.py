    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                ...
                if ftype == TType.STRUCT:
                    self.e = TLikeAlreadyExistsException.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                ...
                if ftype == TType.STRUCT:
                    self.e = TLikeNotFoundException.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                ...
                if ftype == TType.STRUCT:
                    self.e1 = TLikeNotFoundException.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRUCT:
                ...
                if ftype == TType.STRUCT:
                    self.e3 = TPostNotFoundException.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.e2 = TLikeNotAuthorizedException.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                ...
                if ftype == TType.STRUCT:
                    self.e1 = TAccountNotFoundException.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRUCT:
                    self.e2 = TPostNotFoundException.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
