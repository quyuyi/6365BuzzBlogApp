...
TRecPost::~TRecPost() noexcept {
}


void TRecPost::__set_post_id(const int32_t val) {
  this->post_id = val;
}

void TRecPost::__set_tweet_id(const std::string& val) {
  this->tweet_id = val;
}
...
void TRecPost::__set_text(const std::string& val) {
  this->text = val;
}

void TRecPost::__set_keywords(const std::vector<std::string> & val) {
  this->keywords = val;
}
std::ostream& operator<<(std::ostream& out, const TRecPost& obj)
{
  obj.printTo(out);
  return out;
}
...
uint32_t TRecPost::read(::apache::thrift::protocol::TProtocol* iprot) {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->keywords.resize(_size10);
            uint32_t _i14;
            for (_i14 = 0; _i14 < _size10; ++_i14)
            {
              xfer += iprot->readString(this->keywords[_i14]);
            }
...
uint32_t TRecPost::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("TRecPost");

  xfer += oprot->writeFieldBegin("post_id", ::apache::thrift::protocol::T_I32, 1);
  xfer += oprot->writeI32(this->post_id);
  xfer += oprot->writeFieldEnd();
  ...
  xfer += oprot->writeFieldBegin("keywords", ::apache::thrift::protocol::T_LIST, 5);
  {
    ...
    for (_iter15 = this->keywords.begin(); _iter15 != this->keywords.end(); ++_iter15)
    {
...
void swap(TRecPost &a, TRecPost &b) {
  using ::std::swap;
  swap(a.post_id, b.post_id);
...
TRecPost::TRecPost(const TRecPost& other16) {
  post_id = other16.post_id;
  tweet_id = other16.tweet_id;
  created_at = other16.created_at;
  text = other16.text;
  keywords = other16.keywords;
}
TRecPost& TRecPost::operator=(const TRecPost& other17) {
  post_id = other17.post_id;
  tweet_id = other17.tweet_id;
  created_at = other17.created_at;
  text = other17.text;
  keywords = other17.keywords;
  return *this;
}
void TRecPost::printTo(std::ostream& out) const {
  using ::apache::thrift::to_string;
  out << "TRecPost(";
  out << "post_id=" << to_string(post_id);
