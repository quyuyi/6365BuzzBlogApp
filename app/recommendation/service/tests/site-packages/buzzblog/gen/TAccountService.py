    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                ...
                if ftype == TType.STRUCT:
                    self.e1 = TAccountInvalidCredentialsException.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRUCT:
                    self.e2 = TAccountDeactivatedException.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                ...
                if ftype == TType.STRUCT:
                    self.e1 = TAccountInvalidAttributesException.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRUCT:
                    self.e2 = TAccountUsernameAlreadyExistsException.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                ...
                if ftype == TType.STRUCT:
                    self.e1 = TAccountNotAuthorizedException.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRUCT:
                    self.e2 = TAccountInvalidAttributesException.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.STRUCT:
                    self.e3 = TAccountNotFoundException.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
