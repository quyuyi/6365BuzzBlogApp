...
class TRecPost(object):
    ...
    def __init__(self, post_id=None, tweet_id=None, created_at=None, text=None, keywords=None,):
        self.post_id = post_id
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TRecPost')
        if self.post_id is not None:
        ...
        if self.tweet_id is not None:
            ...
            oprot.writeFieldEnd()
        if self.created_at is not None:
            oprot.writeFieldBegin('created_at', TType.STRING, 3)
        ...
        if self.keywords is not None:
            oprot.writeFieldBegin('keywords', TType.LIST, 5)
    ...
    def validate(self):
        ...
        if self.tweet_id is None:
            raise TProtocolException(message='Required field tweet_id is unset!')
        if self.created_at is None:
            raise TProtocolException(message='Required field created_at is unset!')
        if self.text is None:
            raise TProtocolException(message='Required field text is unset!')
...
all_structs.append(TRecPost)
TRecPost.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'post_id', None, None, ),  # 1
    (2, TType.STRING, 'tweet_id', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'created_at', 'UTF8', None, ),  # 3
    (4, TType.STRING, 'text', 'UTF8', None, ),  # 4
    (5, TType.LIST, 'keywords', (TType.STRING, 'UTF8', False), None, ),  # 5
)
